...
runners.forEach((runners, fullNames) => {return fullNames.first_name, fullNames.last_name});
...
runners.filter((size) => {return runners.shirt_size === "L"; });
...
runners.reduce((ticketPriceTotal, item) => {return  ticketPriceTotal + item.donations, 0}); 
